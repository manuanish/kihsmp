componentconstructors["playermarkers"] = function (dynmap, configuration) {
  ...
  $(dynmap).bind("playeradded", function (event, player) {
    ...
    var markerPosition = dynmap
      .getProjection()
      .fromLocationToLatLng(player.location);
    player.marker = new L.CustomMarker(markerPosition, {
      elementCreator: function () {
        ...
        $(div)
          ...
          .append(
            (playerImage = $("<img/>")
              .addClass(
                configuration.smallplayerfaces
                  ? "playerIconSm"
                  : configuration.largeplayerfaces
                    ? "playerIconLg"
                    : "playerIcon",
              )
